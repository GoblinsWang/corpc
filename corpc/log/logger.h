...
#define LogError(...)                                                                                               \
    do                                                                                                              \
    {                                                                                                               \
        LoggerCout(corpc::coutType::Error, Error1, corpc::fileType::Error, corpc::terminalType::Error, __VA_ARGS__) \
    } while (0);

#define LogWarn(...)                                                                                            \
    do                                                                                                          \
    {                                                                                                           \
        LoggerCout(corpc::coutType::Warn, Warn1, corpc::fileType::Warn, corpc::terminalType::Warn, __VA_ARGS__) \
    } while (0);

#define LogInfo(...)                                                                                            \
    do                                                                                                          \
    {                                                                                                           \
        LoggerCout(corpc::coutType::Info, Info1, corpc::fileType::Info, corpc::terminalType::Info, __VA_ARGS__) \
    } while (0);

#define LogDebug(...)                                                                                               \
    do                                                                                                              \
    {                                                                                                               \
        LoggerCout(corpc::coutType::Debug, Debug1, corpc::fileType::Debug, corpc::terminalType::Debug, __VA_ARGS__) \
    } while (0);

#define LogTrace(...)                                                                                               \
    do                                                                                                              \
    {                                                                                                               \
        LoggerCout(corpc::coutType::Trace, Trace1, corpc::fileType::Trace, corpc::terminalType::Trace, __VA_ARGS__) \
    } while (0);
}
